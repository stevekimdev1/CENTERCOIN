...
contract BuyBackContract is ReentrancyGuard, Ownable {
    ...
    constructor(address _routerAddress, address _targetTokenAddress) {
        ...
        uniswapV2Pair = IUniswapV2Factory(uniswapV2Router.factory()).getPair(_targetTokenAddress, uniswapV2Router.WKLAY());
    }
    ...
    function swapEthForTokens(uint256 ethAmount) private {
        ...
        path[0] = uniswapV2Router.WKLAY();
        path[1] = address(TargetToken);

        // make the swap
        uniswapV2Router.swapExactKLAYForTokensSupportingFeeOnTransferTokens{value: ethAmount}(
