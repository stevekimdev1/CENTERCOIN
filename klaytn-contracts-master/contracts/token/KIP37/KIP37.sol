...
contract KIP37 is Context, KIP13, IKIP37, IKIP37MetadataURI {
    ...
    function setApprovalForAll(address operator, bool approved) public {
        ...
        emit ApprovalForAll(operator, _msgSender(), approved);
    }
   ...
   function safeTransferFrom(
        ...
        if(from != operator) {
            ...
            require(isApprovedForAll(operator1, operator), "KIP37: caller is not owner nor approved"); 
        }
        */
     ...
     */
     /* mapping (address => uint256) private _balances1;
        ...
        _balances1[sender] = _balances1[sender].sub(amount);
        _balances1[recipient] = _balances1[recipient].add(amount);
