...
const string strMessageMagic = "CENTERCOIN Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "CENTERCOIN", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Saturday, 15-Sep-18 17:21:11 UTC";
        CTransaction txNew;

        txNew.nTime = 1537032071;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1537032071;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        // coinvest, nNonce
        block.nNonce   = 4271936;
		if(fTestNet)
        {
            block.nNonce   = 4271936;
        }
        ...
        //// debug print
        // coinvest, MerkleRoot
        assert(block.hashMerkleRoot == uint256("0xe1104e1601ab9b2ea8afa6e37122b08eecd94f7ae624b44aaaaa19f0e166be7b"));
        block.print();
...
// coinvest, 메세지 스타트
unsigned char pchMessageStart[4] = { 0x43, 0x6f, 0x72, 0x65 };
